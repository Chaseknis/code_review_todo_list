...
# 📖<a name="about-project">TOdo List</a>


***Todo list is a project built using webpack and HTML/CSS, with features that allow you to add to update the list by adding or removing tasks***


## 🛠 Built With <a name="built-with">HTML/CSS AND Webpack</a>
...
A beginner developer can use this app as a starting point for creating other HTML projects that are properly set up with Webpack and have ESLint configured.
...
```sh
  gh repo clone Chaseknis/todo_list_module_two_project
  cd hello-world
  npm install -y
```
<br><br>
...
Feel free to check the [issues page](https://github.com/Chaseknis/todo_list_module_two_project/issues).
